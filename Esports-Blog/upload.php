<?php
        ...
        if(isset($_POST['submit'])){
            ...
            $insertQuery = "INSERT INTO `post` (`post_id`, `category`, `blog_title`, `blog_content`, `author_name`, `thumbnail`, `blog_date`, `fb_link`, `insta_link`, `twit_link`) VALUES (NULL, '$pCategory', ' $blogTitle', '$content', '$author', '$fileNameNew', CURRENT_DATE(), '$fbLink', '$instaLink', '$twiLink')";
            $dataBase ->query($insertQuery);
            header("Location: create_post.php?PostUploaded");
        }
?>